  ...
  return (
    <>
      <style>{`
        ...
        .a-f2 { animation-delay: 0.13s; }
        .a-f3 { animation-delay: 0.21s; }
        .a-f4 { animation-delay: 0.29s; }
        .a-f5 { animation-delay: 0.37s; }
        .a-f6 { animation-delay: 0.45s; }
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingBottom: 32 }}>
            ...
            <div style={{ marginTop: 32 }}>
              ...
              <p style={{
                ...
                Set up your brand brain once. Lumen handles the rest — writing, designing, and publishing for you.
              </p>
            </div>
          </div>
          ...
          <div style={{ width: '100%', maxWidth: 360 }}>
            ...
            <div className="a-field a-f1" style={{ marginBottom: 44 }}>
              ...
              <p style={{ fontFamily: 'var(--font-ibm)', fontWeight: 300, fontSize: 13.5, color: 'rgba(196,185,154,0.5)' }}>
                Start automating your brand&apos;s social presence
              </p>
            </div>
            ...
            <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              ...
              <div className="a-field a-f5" style={{ paddingTop: 6 }}>
            ...
            <div className="a-field a-f6" style={{ marginTop: 28, textAlign: 'center' }}>
              <span style={{ fontFamily: 'var(--font-ibm)', fontWeight: 300, fontSize: 13, color: 'rgba(196,185,154,0.38)' }}>
                Already have an account?{' '}
                <Link href="/login" style={{ color: '#D4A84B', textDecoration: 'none' }}>
                  Sign in
                </Link>
              </span>
            </div>
